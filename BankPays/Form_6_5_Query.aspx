<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_6_5_Query.aspx.cs" Inherits="BankPays.Form_6_5_Query" %>

<!DOCTYPE html>
<%--<%@ Import Namespace="upacp_sdk_net.com.unionpay.sdk" %>--%>
<%@ Import Namespace="BankPays.Code" %>
...
<%
   ...
   //以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考
    ...
    param["orderId"] = "1170222104210646";//请修改被查询的交易的订单号
    param["merId"] = Convert.ToString(ConfigurationManager.AppSettings["BankPayID"]);//商户代码，请改成自己的测试商户号
    param["txnTime"] = "20170222104210";//请修改被查询的交易的订单发送时间
